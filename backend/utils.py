...
def construct_file_path(project_name, file_name):
    ...
    return os.path.join(AUDIO_FILES_DIR, project_folder, file_name)
...
def generate_spectrogram(file_path, results_dir=RESULTS_FILES_DIR, obs_data=None):
    """
    ...
    detection_data_json = df.to_json(orient='records')
